...
- [ ] **開發規範一致性**
  - [ ] 變數函數等命名符合 [命名規範](./references/target/naming-convention.md)
  - [ ] HTTP Client 呼叫符合 [HTTP請求規範](./references/target/http-request.md)
  - [ ] 本地與跨域狀態管理符合 [狀態管理規範](./references/target/state-management.md)
  - [ ] 表單驗證符合 [表單驗證規範](./references/target/form-validation.md)
  - [ ] UI/UX 設計符合 [UI/UX 設計規範](./references/target/ui-ux-design.md)
  - [ ] 路由註冊符合 [路由註冊規範](./references/target/router-registration.md)
